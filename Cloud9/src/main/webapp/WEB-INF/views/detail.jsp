			...
			<c:choose>
				...
				<c:otherwise>
					<div class="col-sm-3 loginbox solo">
						<p class="kr-font welcomeBoard" style="font-size: 20px;">${users.nick}님
							반갑습니다</p>
					</div>
				</c:otherwise>
			</c:choose>
					...
					<div class="tab-box">
						<div class="analy-top">
							<div class='analy-inner analy-inner-left'>
								<p class='kr-font' style="font-size: 20px;">평점 분석</p>
								...
								<div class='rating-inner rating-right'>
									...
									<div class='point word kr-font'>
										<p>
											...
											<span id="ui-word-title" class="ui-word">${appinfo[0].appname}</span><br>의
											평점
										</p>
									</div>
								</div>
							...
							<div class='analy-inner analy-inner-right'>
								<p class='kr-font' style="font-size: 20px;">전체평점분포</p>
						...
						<div class='bottom-review-box'>
							<h5 class="kr-font">감정에 따른 도움이 되는 리뷰</h5>
						</div>
					</div>
