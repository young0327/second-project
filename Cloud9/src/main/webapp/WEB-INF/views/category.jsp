...
<link rel="stylesheet" type="text/css"
	href=" ${pageContext.request.contextPath}/resources/css/category.css?ver=1">
<title>AppV</title>
...
<body>
	...
	<nav class="top-navbar shadow p-3 mb-5 bg-white rounded Modal">
		...
		<div class="navbar-box row">
			...
			<c:choose>
				...
				<c:otherwise>
					<div class="col-sm-3 loginbox solo kr-font">
						<p class="font-kr" style="font-size: 20px;">${users.nick}님
							반갑습니다</p>
					</div>
				</c:otherwise>
			</c:choose>
					...
					<li class="sidebar-personal-list"><i class="icon fas fa-home"></i><a
						class="list-a kr-font" href="main">홈 화면
							<li class="sidebar-personal-list"><i
								...
								class="list-a category font-kr" href="#">카테고리
				...
				<div class="main-content-carousel shadow p-3 mb-5 bg-white rounded">
					<c:choose>
						<c:when test="${cateList[0].appcate eq 'MF'}">
							<div class="kr-font result-alert">
								<p>
									<span
										style="font-size: 32px; color: rgb(23, 69, 79); font-weight: 700;">음악</span>
									카테고리
								</p>
							</div>
						</c:when>
						<c:when test="${cateList[0].appcate eq 'HF'}">
							<div class="kr-font result-alert">
								<p>
									<span
										style="font-size: 32px; color: rgb(23, 69, 79); font-weight: 700;">여행</span>
									카테고리
								</p>
							</div>
						</c:when>
						<c:when test="${cateList[0].appcate eq 'PF'}">
							<div class="kr-font result-alert">
								<p>
									<span
										style="font-size: 32px; color: rgb(23, 69, 79); font-weight: 700;">사진/비디오</span>
									카테고리
								</p>
							</div>
						</c:when>
					...
					<div class="categoryBox">
						<c:forEach items="${cateList}" var="cateList">
							<div class="result-box row">
								<div class="app-icon-img col-md-3">
									<img src=${cateList.appicon}>
								</div>
								<div class="kr-font app-content-box col-md-9">
									<h5 class="kr-font">
										<a href="detail.do?appid=${cateList.appid}"
											style="color: black;">${cateList.appname}</a>
									</h5>
										...
										<c:choose>
											...
											<c:otherwise>
												...
												<span style="font-size: 15px;">&nbsp&nbsp&nbsp
													${cateList.appprice}원</span>
											</c:otherwise>
										</c:choose>
									</p>
									<p class="word" style="margin-left: 500px; margin-top: -60px;">${cateList.appcompany}</p>
								</div>
							</div>
						</c:forEach>
					</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/cateprice.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/hashtag.js"></script>
	<script>
