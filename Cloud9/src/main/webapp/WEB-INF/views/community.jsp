...
<link rel="stylesheet"
	href=" ${pageContext.request.contextPath}/resources/css/community.css?ver=1">
	...
	<nav class="top-navbar shadow p-3 mb-5 bg-white rounded Modal">
		...
		<div class="comm-black-modal">
			<div class="comm-white-modal shadow p-3 mb-5 bg-white rounded">
				<div class="modal-box">
					<form id="write_frm">
						<div class="comm-writing">
							<p style="font-family: 'Noto Sans KR', sans-serif;">글쓰기</p>
						</div>
						<div class="comm-writer">
							<p class="modal-p">작성자</p>
							<input class="comm-input kr-font" type='text' name="id"
						...
						<div class="comm-title">
							<p class="modal-p">제목</p>
							<input class="comm-input" type='text' id='title' name='title'>
						</div>
						<div class="comm-content">
							<p class="modal-p">내용</p>
							<textarea class="modal-area" id='content' name='content'></textarea>
						</div>
						<div class="comm-btn">
							<button type="button" id="commbtn" class="btn btn-dark">작성하기</button>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="board-detail-whitemodal shadow p-3 mb-5 bg-white rounded">
				<div class="modal-box">
					...
					<div class="detail-btnbox">
						<div>
							<button class="detail-btn btn" id="boardDelete">
								<i class="fas fa-trash-alt"></i>
							</button>
						</div>
						<div>
							<button class="detail-btn btn" id="boardModify">
			...
			<div class="modifying-modal-white">
				<form id="modifyFrm">
					<div class="modifying-modal-box">
						<div class="modifying-writing">
							<p style="font-family: 'Noto Sans KR', sans-serif;">글 수정하기</p>
						</div>
						<div class="modifying-writer">
							<p class="modifying-modal-p">작성자</p>
							<input class="modifying-input mdc" type='text'
								value="${users.id}" readonly="readonly">
						</div>
						<span class="mdc" id="modiBidx" style="display: none"></span>
						<div class="modifying-option">
							<p class="modifying-modal-p">카테고리</p>
							<select class="modifying-modal-select" name="modicate"
								id="modicate">
								<option value="여행/숙박">여행/숙박</option>
								<option value="음악">음악</option>
								<option value="게임">게임</option>
						...
						<div class="modifying-title">
							<p class="modifying-modal-p">제목</p>
							<input class="modifying-input mdc" type='text' name='title'
								id="modititle">
						</div>
						<div class="modifying-content">
							<p class="modifying-modal-p">내용</p>
							<textarea class="modifying-modal-area mdc" name='content'
								id="modicontent"></textarea>
						</div>
						<div class="modifying-btn">
							<button type="button" id="modibtn" class="btn btn-dark">수정하기</button>
						</div>
					</div>
					<form>
			</div>
			...
			<c:choose>
				...
				<c:otherwise>
					<div class="col-sm-3 loginbox solo">
						<p class="welcomeBoard kr-font" style="font-size: 20px;">${users.nick}님
							반갑습니다</p>
					</div>
				</c:otherwise>
			</c:choose>
			...
			<div class="sidebar col-sm-2" id="List">
				<ul class="sidebar-list">
					<li class="sidebar-personal-list"><i class="icon fas fa-home"></i><a
						class="list-a kr-font" href="main">홈 화면
							<li class="sidebar-personal-list"><i
								class="icon fas fa-adjust"></i><a
								class="list-a category kr-font" href="#">카테고리
									<div class="list-group">
										<a href="category.do?M"
											class="list-group-item list-group-item-action">음악</a> <a
											href="category.do?P"
											class="list-group-item list-group-item-action">사진/비디오</a> <a
											href="category.do?H"
											class="list-group-item list-group-item-action">여행</a>
									</div>
							</a></li>
							<li class="sidebar-personal-list"><i
								class="icon fas fa-not-equal"></i><a class="list-a kr-font"
								href="compare.do">유사앱 비교</a></li>
							<li class="sidebar-personal-list"><i
								class="icon far fa-comments"></i><a class="list-a kr-font"
								href="community.do?category=category0">커뮤니티</a></li>
							<li class="sidebar-personal-list"><i
								class="icon far fa-comment-alt"></i><a
								class="list-a kr-font writing">글 작성</a></li>
				</ul>
						...
						<div class="article-box">
							<c:forEach items="${boardlist}" var="list">
								<div class="article-list kr-font">
									...
									<div>
										<a><p class="article kr-font" id="test"
												data-value="${list.bidx}">${list.content}</p></a>
									</div>
									<div>
										<span class="article kr-font" style="pointer-events: none;"
											id="list_id">${list.id}</span>
									</div>
								</div>
							</c:forEach>
...
<script
	src="${pageContext.request.contextPath}/resources/js/community.js"></script>
<script>
